...
#ifdef CONFIG_MCU_UPDATE_FILE
CAT2(CONFIG_MCU_UPDATE_FILE, ADR) = CONFIG_MCU_UPDATE_FILE_ADDR;
CAT2(CONFIG_MCU_UPDATE_FILE, LEN) = CONFIG_MCU_UPDATE_FILE_LEN;
CAT2(CONFIG_MCU_UPDATE_FILE, OPT) = CONFIG_MCU_UPDATE_FILE_OPT;
#ifdef CONFIG_MCU_UPDATE_FILE_FILE
CAT2(CONFIG_MCU_UPDATE_FILE, FILE) = CONFIG_MCU_UPDATE_FILE_FILE;
#endif
