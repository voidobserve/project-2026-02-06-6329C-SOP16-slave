...
#define MULTI_TEST_WRITE_UUID                 0xFFF3
//---------------------------------------------------------------------------
//指定搜索uuid
//指定搜索uuid
static const target_uuid_t  jl_multi_search_uuid_table[] = {
    ...
    {
        .services_uuid16 = 0xFFF0,
        .characteristic_uuid16 = 0xFFF1,
        .opt_type = ATT_PROPERTY_WRITE,
    },

    {
        .services_uuid16 = 0xFFF0,
        .characteristic_uuid16 = 0xFFF2,
        .opt_type = ATT_PROPERTY_NOTIFY,
    },

    {
        .services_uuid16 = 0xFFF0,
        .characteristic_uuid16 = 0xFFF3,
        .opt_type = ATT_PROPERTY_WRITE,
    },
...
//配置多个扫描匹配设备
static const u8 cetl_test_remoter_name1[] = "AC632N_1(BLE)";//
