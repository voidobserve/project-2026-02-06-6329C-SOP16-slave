...
#define TCFG_HW_SPI1_BAUD		64000000L
...
#define TCFG_HW_SPI2_BAUD		32000000L
#define TCFG_HW_SPI2_MODE		SPI_MODE_BIDIR_1BIT
#define TCFG_HW_SPI2_ROLE		SPI_ROLE_MASTER


#define LCD_SPI_INDEX_SEL       1
#define LCD_SPI_PIN_RST         IO_PORTA_01
#define LCD_SPI_PIN_CS          IO_PORTA_02
#define LCD_SPI_PIN_RS          IO_PORTA_00
#define LCD_SPI_PIN_BL          IO_PORTB_01

#define FLASH_SPI_INDEX_SEL     2
#define FLASH_SPI_PIN_CS        IO_PORTB_04
...
//                                 时钟配置                                    //
//*********************************************************************************//
#define CONFIG_BT_NORMAL_HZ	            (192 * 1000000L)
