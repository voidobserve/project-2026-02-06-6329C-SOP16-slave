...
void ble_comm_init(const gatt_ctrl_t *control_blk)
{
    ...
    if (SUPPORT_MAX_GATT_SERVER && STACK_IS_SUPPORT_GATT_SERVER() && gatt_control_block->server_config) {
    ...
    if (SUPPORT_MAX_GATT_CLIENT && STACK_IS_SUPPORT_GATT_CLIENT() && gatt_control_block->client_config) {
