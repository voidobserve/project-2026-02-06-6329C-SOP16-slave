...
extern u8 get_device_role(void);

#define STACK_IS_SUPPORT_GATT_SERVER()  (get_device_role() == 1 || get_device_role() == 0)//(config_le_gatt_server_num)//
#define STACK_IS_SUPPORT_GATT_CLIENT()  (get_device_role() == 0)//(config_le_gatt_client_num)
...
void ble_gatt_server_module_do_enable(u8 en);
